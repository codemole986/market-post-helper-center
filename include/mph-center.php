...
class MPH_Center {
    ...
    public function init() {
        ...
        add_action('mph_remote_publish_preloaded_proceed', array($this, 'render_publish_preloaded_proceed_outside'), 1, 1);
    ...
    public function render_publish_preloaded_proceed_outside($posts) {
        $mph_center_messages = get_transient('mph_center_msg_on_publish');
